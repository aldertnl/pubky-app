  ...
  return (
    <PageHeader data-testid="post-page-header" className="pt-0 pb-3">
      ...
      >
        ...
        >
          <Typography as="span" className="shrink-0 pr-1.5 text-2xl leading-8 font-medium text-muted-foreground">
            {titlePrefix}{' '}
          </Typography>
          <Typography
            as="span"
            className="min-w-0 flex-1 truncate text-2xl leading-8 font-medium text-muted-foreground"
          >
            {authorName}
          </Typography>
        </Typography>
